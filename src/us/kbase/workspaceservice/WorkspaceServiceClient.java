...
public class WorkspaceServiceClient {
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public List<Tuple11<String, String, String, Long, String, String, String, String, String, String, Map<String,Object>>> listWorkspaceObjects(ListWorkspaceObjectsParams params) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
        TypeReference<List<List<Tuple11<String, String, String, Long, String, String, String, String, String, String, Map<String,Object>>>>> retType = new TypeReference<List<List<Tuple11<String, String, String, Long, String, String, String, String, String, String, Map<String,Object>>>>>() {};
        List<List<Tuple11<String, String, String, Long, String, String, String, String, String, String, Map<String,Object>>>> res = caller.jsonrpcCall("workspaceService.list_workspace_objects", args, retType, true, false);
        return res.get(0);
//        TypeReference<Object> retType = new TypeReference<Object>() {};
//        Object ret = caller.jsonrpcCall("workspaceService.list_workspace_objects", args, retType, true, false);
//        return ret;
    }
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public List<Object> getJobs(GetJobsParams params) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
