 ...
 *     @optional md5 location function protein_translation protein_families subsystems roles publications subsystems subsystem_data aliases annotations regulon_data atomic_regulons coexpressed_fids co_occurring_fids dna_sequence protein_translation_length dna_sequence_length
...
public class Feature {
    ...
    private List<us.kbase.common.service.Tuple3 <String, String, Long>> annotations;
    @JsonProperty("subsystem_data")
    private List<us.kbase.common.service.Tuple3 <String, String, String>> subsystemData;
    @JsonProperty("regulon_data")
    private List<us.kbase.common.service.Tuple3 <String, List<String> , List<String>>> regulonData;
    @JsonProperty("atomic_regulons")
    private List<us.kbase.common.service.Tuple2 <String, Long>> atomicRegulons;
    @JsonProperty("coexpressed_fids")
    private List<us.kbase.common.service.Tuple2 <String, Double>> coexpressedFids;
    @JsonProperty("co_occurring_fids")
    private List<us.kbase.common.service.Tuple2 <String, Double>> coOccurringFids;
    ...
    @JsonProperty("annotations")
    public List<us.kbase.common.service.Tuple3 <String, String, Long>> getAnnotations() {
        return annotations;
    }

    @JsonProperty("annotations")
    public void setAnnotations(List<us.kbase.common.service.Tuple3 <String, String, Long>> annotations) {
        this.annotations = annotations;
    }

    public Feature withAnnotations(List<us.kbase.common.service.Tuple3 <String, String, Long>> annotations) {
        this.annotations = annotations;
        return this;
    }

    @JsonProperty("subsystem_data")
    public List<us.kbase.common.service.Tuple3 <String, String, String>> getSubsystemData() {
        return subsystemData;
    }

    @JsonProperty("subsystem_data")
    public void setSubsystemData(List<us.kbase.common.service.Tuple3 <String, String, String>> subsystemData) {
        this.subsystemData = subsystemData;
    }

    public Feature withSubsystemData(List<us.kbase.common.service.Tuple3 <String, String, String>> subsystemData) {
        this.subsystemData = subsystemData;
        return this;
    }

    @JsonProperty("regulon_data")
    public List<us.kbase.common.service.Tuple3 <String, List<String> , List<String>>> getRegulonData() {
        return regulonData;
    }

    @JsonProperty("regulon_data")
    public void setRegulonData(List<us.kbase.common.service.Tuple3 <String, List<String> , List<String>>> regulonData) {
        this.regulonData = regulonData;
    }

    public Feature withRegulonData(List<us.kbase.common.service.Tuple3 <String, List<String> , List<String>>> regulonData) {
        this.regulonData = regulonData;
        return this;
    }

    @JsonProperty("atomic_regulons")
    public List<us.kbase.common.service.Tuple2 <String, Long>> getAtomicRegulons() {
        return atomicRegulons;
    }

    @JsonProperty("atomic_regulons")
    public void setAtomicRegulons(List<us.kbase.common.service.Tuple2 <String, Long>> atomicRegulons) {
        this.atomicRegulons = atomicRegulons;
    }

    public Feature withAtomicRegulons(List<us.kbase.common.service.Tuple2 <String, Long>> atomicRegulons) {
        this.atomicRegulons = atomicRegulons;
        return this;
    }

    @JsonProperty("coexpressed_fids")
    public List<us.kbase.common.service.Tuple2 <String, Double>> getCoexpressedFids() {
        return coexpressedFids;
    }

    @JsonProperty("coexpressed_fids")
    public void setCoexpressedFids(List<us.kbase.common.service.Tuple2 <String, Double>> coexpressedFids) {
        this.coexpressedFids = coexpressedFids;
    }

    public Feature withCoexpressedFids(List<us.kbase.common.service.Tuple2 <String, Double>> coexpressedFids) {
        this.coexpressedFids = coexpressedFids;
        return this;
    }

    @JsonProperty("co_occurring_fids")
    public List<us.kbase.common.service.Tuple2 <String, Double>> getCoOccurringFids() {
        return coOccurringFids;
    }

    @JsonProperty("co_occurring_fids")
    public void setCoOccurringFids(List<us.kbase.common.service.Tuple2 <String, Double>> coOccurringFids) {
        this.coOccurringFids = coOccurringFids;
    }

    public Feature withCoOccurringFids(List<us.kbase.common.service.Tuple2 <String, Double>> coOccurringFids) {
        this.coOccurringFids = coOccurringFids;
        return this;
    }
